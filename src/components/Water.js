...
export default class pendMain extends Component {
  ...
  toggle = () => {
    ...
    let D = (Math.log(11) - Math.log(this.state.T  - 5)) / this.state.n
    ...
    return (
      <div>
        ...
        <div className='flex'>
            ...
            <div className="bg-img"></div>
              ...
              <div className='sidebarBtns'>
                <div className='airSim' >
                  <img src={require('../assets/wind.png')} className='wind lowOpacity' alt=""/>
                  <Link to='/air' className='airbtn lowOpacity'>Симуляция в воздухе</Link>
                </div>
                <div className='airSim'>
          ...
          <div className="main">
            <h1>{isRunning ? 'Чтобы остановить симуляцию нажмите на кнопку паузы' : "Симуляция проходит в воде. Нажмите на кнопку старта"}</h1>
